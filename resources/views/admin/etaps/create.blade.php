...
@section('header', 'Créer une Étape')

@section('content')
<div class="bg-white rounded-lg shadow-md p-6">
    <form action="{{ route('admin.etaps.store') }}" method="POST">
        @csrf
        <div class="space-y-6">
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700">Nom de l'Étape</label>
                <input type="text"
                       name="name"
                       id="name"
                       value="{{ old('name') }}"
